...
const Q_FLAGS = {
  ...
  diagnostic_in_services: {
    title: 'Обстеження внесено як послугу, а не як діагностичний звіт', short: 'обстеження в послугах', high: false,
    rule: 'Пакет НСЗУ вимагає вносити візуалізаційні обстеження (рентген, УЗД, КТ, дуплекс, ехокардіографія) як «Діагностичний звіт», а не в блок «Надані послуги». Якщо звіт уже є — послугу видалити, щоб не було дублювання.',
    why: 'Розрахунок НСЗУ відхиляє такий випадок і не рахує ціну (у ЛШМД 147 епізодів; найчастіше рентген грудної клітки, УЗД черевної порожнини, ехокардіографія). Оплату за обстеження окремо не нараховують — вимога лише до правильного розділу.',
    check: 'Перенести обстеження з «Наданих послуг» у «Діагностичні звіти» (або видалити дублікат послуги, якщо звіт уже внесено).',
    warn: 'У «Наданих послугах» є візуалізаційне обстеження. Перед випискою внесіть його як діагностичний звіт — інакше НСЗУ може відхилити розрахунок. Правило діє не для всіх пакетів (наприклад, інфаркт зі стентуванням приймається).',
  },
  stroke_no_g: {
