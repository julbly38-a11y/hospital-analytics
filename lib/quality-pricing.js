...
const LOSS_SHARE = {
  ...
  // Обстеження в послугах: пряму відмову ставить nszu_refused (розраховані епізоди);
  // для ще не розрахованих правило не завжди діє — власного ризику не додаємо.
  diagnostic_in_services: 0,
  stroke_no_g: 0,
