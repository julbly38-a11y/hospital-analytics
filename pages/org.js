...
/* ── Config ───────────────────────────────────────── */
const BLOCK_CFG = {
  'приймально_діагностичний': { icon: '✚', color: '#c0392b', label: 'Приймально-діагностичне відділення з ЛІТ' },
  'клінічний':                { icon: '♡', color: '#4a9870', label: 'Клінічні відділення' },
  'анестезіологія_іт':        { icon: '◎', color: '#2563eb', label: 'Відділення анестезіології з ліжками ІТ' },
  'параклінічний':            { icon: '≡', color: '#6b6760', label: 'Параклінічні відділення' },
  'адміністративний':         { icon: '⊛', color: '#7c3aed', label: 'Адміністративно-управлінський' },
}
