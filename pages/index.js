...
const ALL_EXAMPLES = [
  ...
  'Картка пацієнта (введіть ПІБ)',
  'Показники по напрямках (терапевтичний/хірургічний)',
...
// Приклади для ролі doctor — про власну роботу
const DOCTOR_EXAMPLES = [
  ...
  'Скільки діб чергування у мене за 2024',
  'Скільки вихідних діб у мене за 2024',
  'Летальність моїх пацієнтів',
  'Скільки моїх пацієнтів з погіршенням стану',
  'Покажи мої випадки інсульту за 2024',
  'Мої пацієнти з епілепсією',
  'Мої випадки розсіяного склерозу',
  'Мої пацієнти з транзиторною ішемічною атакою',
  'Мої випадки епілептичних нападів',
]

// Загальні приклади для лікаря — лише агрегати, доречні неврологу (для порівняння).
// Без хірургії, апендицитів, урології тощо — це інший профіль.
      ...
      <div className={styles.layout}>
        <aside className={styles.sidebar}>
          ...
          <div className={styles.sideSection}>
            ...
            {(role === 'doctor' ? [...DOCTOR_EXAMPLES, ...DOCTOR_GENERAL_EXAMPLES] : ALL_EXAMPLES).map((ex, i) => (
